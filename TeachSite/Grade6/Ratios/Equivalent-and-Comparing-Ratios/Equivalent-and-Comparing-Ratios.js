...
$(document).ready(function() {
	...
	/**
	 * generates the JSON structure to be able to call the questions and the random numbers generated inside of the RatiosStorer.
	 */
	...
	var checkAnswer = function(keyCode) {
		...
		/**
		 * checks to see if the user got the correct answer, if so adds 1 to currentQuestion and displays whether they got it correct or not.
		 * If user has not answered all of the questions then will change the question.
		 */
		if(gotCorrect) {
			currentQuestion++;
