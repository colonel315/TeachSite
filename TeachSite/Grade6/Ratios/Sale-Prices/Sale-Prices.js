/**
 * This will generate Questions for students to answer and having them round to the nearest hundredth. This helps students relate
 * to math by having students taking the cost of an item and then multiplying by the percentage of the sale then subtract that number from
 * the orginal price to find the new price.
 */
