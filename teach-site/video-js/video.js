...
(function() {
	...
	s.wc = function() {
		...
		if(d = c.children)if(h = function(d, e) {
				c[d] !== b && (e = c[d]);
				e !== l && (a[d] = a.V(d, e))
			}, t.g.isArray(d))for(var j = 0; j < d.length; j++)e = d[j], "string" == typeof e ? (g = e, e = {}) : g = e.name, h(g, e);
		else t.g.X(d, h)
	};
	s.T = q("");
	s.c = function(a, c, d) {
	...
	s.xa = function() {
		for(var a = this.d.textTracks(), c = 0, d = a.length, e, g, h = this.Q = []; c < d; c++)if(e = a[c], e.M() == this.H)if(0 === e.readyState())e.load(), e.c("loaded", t.bind(this, this.xa));
		else {
			g = e;
			break
		}
