...
FunctionGame.Game.prototype = {
	create: function() {
		...
		this._player = this.add.sprite(50, FunctionGame.GAME_HEIGHT / 2 + 30, 'player', 0);
	...
	update: function() {
		...
		this.physics.arcade.overlap(this._player, this._answers, this._checkAnswer, null, this);
